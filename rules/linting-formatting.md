...
1. `next`
2. `react`
3. Встроенные модули Node.js
4. Сторонние библиотеки
5. Пустая строка
6. Компоненты (`@components/*`)
7. Пустая строка
8. Внутренние модули (утилиты, хуки)
9. Пустая строка
10. Типы и интерфейсы
11. Пустая строка
12. CSS модули (`.module.scss`)
...
Проект использует конфигурацию ESLint от Next.js:

- `next/core-web-vitals` - правила для Next.js и Core Web Vitals
